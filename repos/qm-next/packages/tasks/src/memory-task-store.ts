/**
 * In-memory task store (qm `src/tasks/memory-task-store.ts`): the
 * reference impl used by tests; production callers reach for the
 * Postgres variant for cross-instance durability.
 */
