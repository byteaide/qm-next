/**
 * YAML frontmatter parser, ported verbatim from qm's `skills/frontmatter.ts`.
 * Fenced top-of-file YAML, block scalar (literal/folded) and flow-array
 * shapes are supported; unrecognized lines are ignored.
 */
