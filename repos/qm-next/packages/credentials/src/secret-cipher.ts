/**
 * Secret box: HKDF-derived AES-256-GCM encryption for credentials at rest,
 * translated from qm's connector-client-store crypto core. The v2 format
 * keeps a legacy-key fallback so a rotated master key never orphans
