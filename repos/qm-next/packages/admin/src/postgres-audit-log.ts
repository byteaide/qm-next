/**
 * Postgres audit log (qm `src/admin/postgres-audit-log.ts`), including the
 * legacy `audit_events` jsonb one-shot migration under the advisory lock.
 */
import { createPgPool, errMessage } from '@qm/store'
