/**
 * Turn attribution (qm `src/admin/attribution.ts`): joins participant
 * windows with attributed turn counts so retention/users analytics can walk
 * per-person activity without a session-store list API.
 */
