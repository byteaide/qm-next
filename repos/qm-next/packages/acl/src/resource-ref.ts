/**
 * Resource ref codec (qm `src/acl/resource-ref.ts`): a `kind:id` pair
 * with file refs using the raw path verbatim and every other kind
 * namespaced by a kind prefix (`skill:`, `deployment:`, `cron:`,
 * `service-cred:`). The codec is the common currency the store,
 * admin routes, and skills plumbing all speak.
 */
