...
export const uiZh = {
  ...
  // --- P4 残留清扫:搜索面板 + 文件页 ---
  "Ask QM to find it:": "让 QM 帮你找:",
  "starts a new chat where QM hunts down the matching session and links it":
    "会开启新会话,由 QM 找到匹配的会话并附上链接",
  "Search every chat you can see — messages, not just titles.":
    "搜索你能看到的所有会话——搜正文,而不只是标题。",
  "Search failed — check the connection and try again.": "搜索失败——请检查连接后重试。",
  "No messages match “{q}”.": "没有匹配“{q}”的消息。",
  "Search your chats…": "搜索你的会话…",
  navigate: "切换",
  "open chat": "打开会话",
  "ask QM in a new chat": "在新会话中询问 QM",
  "Drop files here or choose files": "拖放文件到此处,或点击选择文件",
  "Drop files": "松开即可上传",
  "Uploading…": "上传中…",
  "Loading files…": "正在加载文件…",
  "Files created, uploaded, or shared with you": "由你创建、上传或分享给你的文件",
  Upload: "上传",
  "Search files": "搜索文件",
  ...
  "Uploading {n} files…": "正在上传 {n} 个文件…",
  "Uploaded 1 file.": "已上传 1 个文件。",
  "Uploaded {n} files.": "已上传 {n} 个文件。",
  "Uploaded {a} of {b}.": "已上传 {a}/{b}。",
  "Upload failed.": "上传失败。",
  "Failed to load more files.": "加载更多文件失败。",
  "Failed to load all matching files.": "加载全部匹配文件失败。",
  "Failed to load files.": "文件加载失败。",

  // --- P4 残留清扫:环境行为 / 项目模型 / 钉选头部面板 ---
  "Saved.": "已保存。",
  ...
  every: "每",
  "Batch interval for {name} in hours": "{name} 的汇总间隔(小时)",
  "Remove {name} from the ledger": "从名单中移除 {name}",
  h: "小时",
  "Agent behavior": "智能体行为",
  "Choose what this project should notice and act on.": "选择该项目应关注并处理的内容。",
  "Ambient behavior": "环境监听行为",
  "Default (on when standing orders are set)": "默认(设置了常设指令时开启)",
  On: "开启",
  Off: "关闭",
  on: "开启",
  off: "关闭",
  "When off, the agent never acts on overheard messages here — it only responds to direct @mentions. Default: on only when standing orders (or an action-mode bot) are set below — otherwise mention-only.":
    "关闭后,智能体在此不会处理旁听到的消息——仅响应直接 @提及。默认:仅在设置了常设指令(或行动型机器人)时开启——否则仅限提及。",
  ...
  "Plain-language guidance for proactive work. Leave empty to respond only when addressed.":
    "用自然语言描述主动性工作的指引。留空则仅在被点名时响应。",
  "Automated posters": "自动发言账号",
  "Control how messages from bots and integrations wake the agent.":
    "控制机器人与集成应用的消息如何唤醒智能体。",
  "No bots added. All bot posts are treated as activity.": "尚未添加机器人。所有机器人消息都会被视为活跃动态。",
  "Bot name": "机器人名称",
  "Add bot": "添加机器人",
  "The model every conversation here starts on.": "此处每个会话默认使用的模型。",
  "Default model for this project": "该项目的默认模型",
  "Org default ({model})": "组织默认({model})",
  "— no longer offered": "——已不再提供",
  "Default effort": "默认推理力度",
  "Default effort level for this project": "该项目的默认推理力度",
  Auto: "自动",
  Low: "低",
  Medium: "中",
  High: "高",
  ...
  "Pinned for this project. Anyone in a chat can still pick a different model for that conversation.":
    "已为此项目固定。会话中任何人仍可为单个会话选择其他模型。",
  "The pinned Slack header (when enabled below) names this model.":
    "下方的钉选 Slack 头(启用后)会标明此模型。",
  "Couldn't load this project's model.": "无法加载该项目的模型。",
  "{label} effort": "{label}推理力度",
  "Saved — new conversations here run on {model}{note}.": "已保存——此处的后续新会话将使用 {model}{note}。",
  "Couldn't change the model — try again.": "无法更改模型——请重试。",
  "Pinned header": "钉选头部",
  "A small pinned message in the Slack channel naming the model in use.":
    "Slack 频道中一条钉选的小消息,标明当前使用的模型。",
  "Pinned Slack header for this channel": "此频道的钉选 Slack 头",
  "Header pinned in the channel.": "头部已钉选到频道。",
  "Pinned header removed.": "已移除钉选头部。",
  "Couldn't load the pinned header setting.": "无法加载钉选头部设置。",
