...
export default defineConfig({
  ...
  resolve: {
    alias: [
      { find: /^katex$/, replacement: here("app/src/lazy-katex.ts") },
      { find: "katex-real", replacement: here("node_modules/katex/dist/katex.mjs") },
      { find: /^highlight\.js\/lib\/core$/, replacement: here("app/src/lazy-hljs.ts") },
      ...
      { find: /^highlight\.js\/lib\/languages\/.*$/, replacement: here("app/src/hljs-lang-stub.ts") },
    ],
  },
  build: {
    outDir: "../dist-web",
