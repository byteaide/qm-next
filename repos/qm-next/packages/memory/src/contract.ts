 ...
 *
 * OUT of M3 (m3-scope 14.0): strategy modes beyond static selection,
 * memorable relay, provider routing, MCP provider.
 */
...
export interface ScopeMemory {
  ...
  recall(scopeId: ScopeId, opts?: { maxChars?: number }): Promise<string>
