/**
 * Sandbox contract: P1 parity port of qm src/sandbox/sandbox.ts plus the
 * workspace layer / egress vocabulary the provisioning seam consumes.
 *
 * A Sandbox is a scoped computer backend (local Docker, AWS, Porter, ...):
 * provision a handle for a scope, run commands, move files, and tear down.
