/**
 * Custom model providers: an org admin registers additional providers that
 * speak the OpenAI- or Anthropic-compatible wire protocols. Registered
 * models resolve like built-ins; built-in ids shadow custom ones. Secrets
 * never live here — the runtime registry holds everything except the key.
 */
