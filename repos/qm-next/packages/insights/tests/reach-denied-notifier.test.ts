/**
 * Reach-denied notifier tests (parity 16.0): forwards only events newer
 * than the watermark, oldest first, advances the watermark, and leaves
 * it untouched when a notify throws.
 */
import assert from 'node:assert/strict'
import { test } from 'node:test'
import { createAuditLog, type AuditEvent } from '@qm/admin'
import { createMemoryMap } from '@qm/store'
import { scopeId } from '@qm/types'
import { createReachDeniedNotifier, type ReachDeniedCursor } from '../src/index.ts'
