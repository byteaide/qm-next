...
基线侧 qm 自 2026-09-05 起无移动，不产生新差异。第二批（2026-09-22）后剩余实现类工作 = createPlayground 小移植（第 3 批）+ X3b command-policy 最小版（第 3 批，X3a 审计产出）+ X3b 完整版/scannableCommand/存储分层（第 4 批）+ Q2（依赖 Q0，随偏差挂起）+ 集群 M 多实例。X3a 审计（2026-09-22）已完成。
