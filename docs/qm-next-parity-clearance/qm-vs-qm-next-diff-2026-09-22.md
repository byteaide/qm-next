...
2. **未移植模块**：`connectors/oauth.ts`（IM provider OAuth 栈，注释称"待 P5 18.0 IM providers 落地"）、Fly/AWS 部署 provider（2026-09-22 拍板暂缓；publish 随之登记有意偏差）。portal impersonation 已于 2026-09-22 第 5 批 5b 收口（见 Portal 行）。
